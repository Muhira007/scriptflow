...
export async function GET(request: NextRequest) {
  try {
    ...
    return NextResponse.json({
      aiProvider: settingsObj.AI_PROVIDER || "gemini",
      geminiApiKey: settingsObj.GEMINI_API_KEY || "",
      hasGeminiKey: !!settingsObj.GEMINI_API_KEY,
      deepseekApiKey: settingsObj.DEEPSEEK_API_KEY || "",
      hasDeepseekKey: !!settingsObj.DEEPSEEK_API_KEY,
      midtransServerKey: "",
      midtransClientKey: "",
